...
export const Navigation: React.FC<NavigationProps> = ({ onSettingsClick }) => {
  ...
  // Navigation items - NO settings gear here, it's in the hamburger menu
          ...
          <>
            ...
            <div className="absolute bottom-20 right-4 left-4 bg-card border border-border shadow-xl rounded-2xl z-50">
              <div className="p-4 space-y-2">
                ...
                {/* App Version */}
                <div className="w-full flex items-center justify-center px-4 py-2 text-xs text-muted-foreground">
                  {language === 'he' ? 'גרסה' : 'Version'} 1.0.0
                </div>
              </div>
            </div>
          </>
