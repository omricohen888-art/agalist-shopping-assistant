...
export const ShoppingList = () => {
  ...
  return <div className="min-h-screen bg-white dark:bg-slate-900 pb-32 transition-colors duration-150" dir={direction} lang={language}>
    ...
    {/* Main Content */}
    <div className="max-w-3xl mx-auto p-3 sm:p-4 md:p-6 lg:p-8 pb-28 md:pb-8 overflow-hidden w-full min-w-0">
      {/* Welcome Header */}
      <div className="text-center mb-3 sm:mb-4 md:mb-6 mt-2 sm:mt-3">
        <h1 className="text-xl sm:text-2xl font-bold text-foreground mb-1 inline-block">
          ...
          <div className="h-0.5 w-3/4 mx-auto mt-0.5 bg-gradient-to-r from-transparent via-primary to-transparent rounded-full" />
        </h1>
      ...
      <div className="relative bg-gradient-to-b from-primary/[0.04] to-card dark:from-primary/[0.08] dark:to-slate-800/90 border-2 border-foreground/80 dark:border-foreground/60 rounded-2xl p-3 sm:p-4 md:p-6 mb-4 sm:mb-6 shadow-[0_4px_20px_-4px_hsl(var(--primary)/0.12)] hover:shadow-[0_6px_24px_-4px_hsl(var(--primary)/0.18)] focus-within:shadow-[0_6px_24px_-4px_hsl(var(--primary)/0.2)] transition-all duration-300 overflow-hidden backdrop-blur-sm">
        ...
        <div className="flex flex-col items-center gap-2 sm:gap-3 mt-4 sm:mt-6 w-full transition-all duration-300 ease-in-out relative z-10">
          ...
          {/* Finish Shopping - appears only when items are checked */}
